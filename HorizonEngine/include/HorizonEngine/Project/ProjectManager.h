...
class ProjectManager {
 ...
 public:
  ...
  ///	If you provide a directory path, it generates a new project in that
  ///directory. 	If you provide a file path, it checks whether this path is to
  ///the file.hzn, 	and depending on that file, the project is loaded. 	param name
  ///name of the folder to create project. 	param directoryPath directory in
  ///which the project directory should be created. 	return
  /// </summary>
