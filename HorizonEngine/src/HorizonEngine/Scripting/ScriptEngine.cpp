...
namespace Hzn
{
	...
	void ScriptEngine::initMono()
	{
		...
		s_Data->coreAssembly = LoadCSharpAssembly("Scripts/ScriptCoreLib.dll");

		// function that prints out all the assembly types.
		PrintAssemblyTypes(s_Data->coreAssembly);

		// get the MonoImage for the assembly.
		MonoImage* assemblyImage = mono_assembly_get_image(s_Data->coreAssembly);

		// get mono class from the image.
		MonoClass* monoClass = mono_class_from_name(assemblyImage, "Hzn", "Main");
