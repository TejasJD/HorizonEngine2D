...
//! the main App run loop. This loop keeps the application running and updates
//! and renders different layers
void App::run() {
...
//! the onEvent function of application class that handles any events coming to
//! the application
void App::onEvent(Event& e) {
  EventDispatcher dispatcher(e);
  dispatcher.Dispatch<WindowCloseEvent>(
      std::bind(&App::onWindowClose, this, std::placeholders::_1));
