...
namespace Hzn {
/// <summary>
/// Provides a switch case to cater to scenario where openGL isn't the shader
/// Used otherwise calls the GLShader class
/// </summary>
...
/// <summary>
/// Provides a switch case to cater to scenario where openGL isn't the shader
/// Used otherwise calls the GLShader class Takes in the the source of the
/// vertex & fragment sources as parameters
/// </summary>
